 ...
 *
 * @property {external:Integer} [maxPort]
 *  This configures the maxPort of the endpoint.
 *
 * @property {module:core.MediaPipeline} mediaPipeline
 *  the {@link module:core.MediaPipeline MediaPipeline} to which the endpoint 
 *  belongs
 *
 * @property {external:Integer} [minPort]
 *  This configures the minPort of the endpoint.
 *
